...
Current workflow files are placeholders for future automation. `make validate` checks local scaffold directories, and `make validate-workflows` checks that workflow scaffolding is present.
